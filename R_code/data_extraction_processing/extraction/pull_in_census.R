...
################################# Investigate some tables  
# help(listCensusMetadata) is really helpful here.
#pull in the data and subset 
...
# Examine  records of selected groups. 
...
# Pull in and tidy up some Census data on household income at the ZCTA level
income <- getCensus(
  name = "acs/acs5/subject",
  vintage = 2022,
