...
predict x1b1hat, xb
gen x1b1hat05 = x1b1hat - _b[lavgrexp]*lavgrexp + _b[lavgrexp]*log(5000)
gen scale05 = normden(x1b1hat05)
gen pe05 = scale05*_b[lavgrexp]
sum pe05
return scalar ape05 = r(mean)
gen x1b1hat25 = x1b1hat - _b[lavgrexp]*lavgrexp + _b[lavgrexp]*log(5710)
gen scale25 = normden(x1b1hat25)
gen pe25 = scale25*_b[lavgrexp]
sum pe25
return scalar ape25 = r(mean)
gen x1b1hat50 = x1b1hat - _b[lavgrexp]*lavgrexp + _b[lavgrexp]*log(6222)
gen scale50 = normden(x1b1hat50)
gen pe50 = scale50*_b[lavgrexp]
sum pe50
return scalar ape50 = r(mean)
gen x1b1hat75 = x1b1hat - _b[lavgrexp]*lavgrexp + _b[lavgrexp]*log(6831)
gen scale75 = normden(x1b1hat75)
gen pe75 = scale75*_b[lavgrexp]
sum pe75
return scalar ape75 = r(mean)
gen x1b1hat95 = x1b1hat - _b[lavgrexp]*lavgrexp + _b[lavgrexp]*log(8440)
gen scale95 = normden(x1b1hat95)
gen pe95 = scale95*_b[lavgrexp]
sum pe95
